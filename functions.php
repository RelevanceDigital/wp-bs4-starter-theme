...
function _s_scripts() {
	...
	wp_enqueue_script( '_s-bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js', array('jquery'), '0', true );

	wp_enqueue_script( '_s-script', get_template_directory_uri() . '/assets/js/site.js', array('jquery','_s-bootstrap'), '0', true );

	wp_enqueue_script( '_s-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '0', true );

	wp_enqueue_script( '_s-focus-visible-pollyfill', get_template_directory_uri() . '/assets/js/focus-visible.js', array(), '0', true );
